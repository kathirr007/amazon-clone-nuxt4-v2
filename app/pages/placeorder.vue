...
// Fetch initial data
const { data: initialData } = await useFetch('/api/shipment', {
  method: 'POST',
  body: { shipment: 'normal' },
})

const { data: addressData } = await useFetch('/api/addresses')

if (initialData.value) {
  cartStore.setShipping({
    price: initialData.value.shipment.price,
    estimatedDelivery: initialData.value.shipment.estimated,
  })

  shippingPrice.value = initialData.value.shipment.price
  estimatedDelivery.value = initialData.value.shipment.estimated
}

if (addressData.value) {
  addresses.value = addressData.value.addresses
}
  ...
  <div class="container-fluid">
    <div class="shipping-address">
      <div class="navbarShipping a-spacing-large">
        <nuxt-link to="/">
          <img src="/img/placeHeadernav.gif" alt="" class="img-fluid">
        </nuxt-link>
      </div>
      <div class="a-row">
                      ...
                      <ul class="no-bullet-list">
                        <li class="a-spacing-micro">
                          <span class="a-list-item">
                            <span>
                              <img alt="" src="/img/visa.gif" class="img-fluid">
                            </span>
                            ending in
                            <span>6397</span>
                          </span>
                    ...
                    >
                      <div class="row">
                        <div class="col-sm-3 col-3">
                          <img alt="" :src="product.photo" style="width: 100px">
                        </div>
                      ...
                      <fieldset>
                        ...
                        <div class="a-spacing-mini wednesday">
                          ...
                          <span class="a-radio-label">
                            ...
                            <br>
                            <span class="a-color-secondary">$13.98 - Standard International Shipping - No
                              Tracking</span>
                          </span>
                        </div>
                        <br>
      ...
      <div class="a-row a-spacing-small a-spacing-top-small">
        ...
        <p id="state-sales-tax-info" class="a-color-secondary a-size-mini">
          ...
          <a href="#">Important information regarding sales tax you may owe in your
            State</a>
        </p>
