      ...
      <div class="container-fluid desktop-nav">
        <div class="row">
          ...
          <div class="col-sm-2">
            <div class="logo-area">
              <nuxt-link to="/">
                <b-img src="/img/logo.png" alt="Logo" fluid></b-img>
              </nuxt-link>
            </div>
          </div>
        ...
        <div class="row">
          ...
          <!-- Shopping -->
          <b-col cols="6" sm="6" md="4" lg="5" xl="6" class="p-0">
            <div class="nav-fill">
              <div class="nav-shop">
          ...
          <b-col cols="4" sm="4" md="6" lg="5" xl="4" class="p-0">
            <div class="nav-tools">
